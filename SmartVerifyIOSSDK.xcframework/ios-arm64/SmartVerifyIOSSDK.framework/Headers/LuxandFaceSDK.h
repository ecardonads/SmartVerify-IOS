...
//
//
//  Copyright(c) 2005-2024 Luxand, Inc.
//         http://www.luxand.com
//
///////////////////////////////////////////////////
...
#define _FSDKVARIMPORT_ __declspec(dllimport)
#define _FSDKIMPORT_  _FSDKVARIMPORT_ __cdecl
#include <windows.h>
#else
#define _FSDKVARIMPORT_
#define _FSDKIMPORT_
#define __cdecl
#endif
...
int _FSDKIMPORT_ FSDK_LoadImageFromPngBufferWithAlpha(HImage * Image, unsigned char * Buffer, unsigned int BufferLength);
...
typedef struct {
	int Width;
	int Height;
	int BPP; // int FormatIndex; for v4l2 / MediaFoundation
...
#ifdef linux
int _FSDKIMPORT_ FSDK_GetCameraList(char*** CameraList, int* CameraCount);
int _FSDKIMPORT_ FSDK_GetCameraListEx(char*** CameraNameList, char*** CameraDevicePathList, int* CameraCount);
int _FSDKIMPORT_ FSDK_FreeCameraList(char** CameraList, int CameraCount);
int _FSDKIMPORT_ FSDK_GetVideoFormatList(const char* CameraName, FSDK_VideoFormatInfo** VideoFormatList, int* VideoFormatCount);
int _FSDKIMPORT_ FSDK_SetVideoFormat(const char* CameraName, FSDK_VideoFormatInfo VideoFormat);
int _FSDKIMPORT_ FSDK_OpenVideoCamera(const char* CameraName, int* CameraHandle);
#endif
...
_FSDKVARIMPORT_ extern const int FSDK_VIDEO_FORMAT_SIZE;
_FSDKVARIMPORT_ extern const char* const FSDK_VideoFormatDescription[];
